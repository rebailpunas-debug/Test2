...
func Initialize(cla setting.CommandLineArgs, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	httpclientProvider := httpclientprovider.New(cfg, tracer)
	...
	usageStats := service.ProvideService(cfg, sqlStore, pluginManager, socialService, kvStore, routeRegisterImpl, featureManager)
	...
	backgroundServiceRegistry := backgroundsvcs.ProvideBackgroundServiceRegistry(httpServer, alertNG, cleanUpService, grafanaLive, gateway, notificationService, pluginManager, renderingService, userAuthTokenService, tracer, provisioningServiceImpl, alertEngine, usageStats, grafanaService, pluginsService, internalMetricsService, secretsService, remoteCache, thumbsService, storageService, dashboardsnapshotsService, alertNotificationService, serviceAccountsService, guardianProvider, dashboardUpdater)
